...
for (i in 1:scenarios) {
  ...
  load(paste0("pop_data/non_norm/IPD_AC_", file.id, ".RData")) # load AC patient-level data
  load(paste0("pop_data/non_norm/ALD_BC_", file.id, ".RData")) # load BC aggregate-level data
  IPD.AC.all[[i]] <- IPD.AC
  ALD.BC.all[[i]] <- ALD.BC
}
...
for (i in 1:scenarios){
  ...
  save(bucher.results, file = paste0("results/non_norm3/bucher_", file.id, ".RData"))
  ...
  save(maic.results, file = paste0("results/non_norm3/maic_", file.id, ".RData"))
  ...
  save(CE.results, file = paste0("results/non_norm3/ce_", file.id, ".RData"))
  ...
  save(bayes_gcomp.results, file = paste0("results/non_norm3/bayes_gcomp_", file.id, ".RData"))
  ...
  save(mis_bayes_gcomp.results, file = paste0("results/non_norm3/mis_bayes_gcomp_", file.id, ".RData"))
}
